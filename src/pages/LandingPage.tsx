          ...
          <div id="get-started" className="w-full max-w-md bg-white rounded-[24px] border-3 border-main-text p-8 space-y-6 relative shadow-[8px_8px_0px_#1A1A2E] transform transition-transform duration-300">
            ...
            <div className="space-y-4">
              ...
              <button
                onClick={onLineLogin}
                disabled={isAnyLoading}
                className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-[#06C755] text-white border-2 border-main-text rounded-xl font-nunito font-black text-main-text hover:bg-[#05b34c] shadow-[3px_3px_0px_#1A1A2E] active:translate-x-[1px] active:translate-y-[1px] active:shadow-[2px_2px_0px_#1A1A2E] transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none cursor-pointer"
              >
                {isLineLoading ? (
                ...
                <span className="text-sm font-black">{t('auth.line_login')}</span>
              </button>
