    ...
    <>
      <div className="fixed-in-container bottom-0 z-20 p-4 pb-[calc(env(safe-area-inset-bottom)+16px)] pt-2 select-none w-full max-w-[480px] pointer-events-none">
        <div className={`relative bg-white/70 backdrop-blur-xl border border-white/50 shadow-[0_8px_32px_rgba(26,26,46,0.08),inset_0_2px_4px_rgba(255,255,255,0.8),inset_0_-1px_2px_rgba(26,26,46,0.05)] px-0 py-2.5 grid grid-cols-5 items-center rounded-[30px] overflow-visible transition-all duration-300 ease-out origin-center ${
          ...
          <div className="absolute inset-0 rounded-[29px] bg-gradient-to-b from-white/35 via-white/5 to-transparent pointer-events-none z-0" />
          ...
          {groupId && activeLeft !== undefined && (
            ...
            >
              <div className="mx-1.5 h-full rounded-[22px] bg-brand-light/95 border border-white/60" />
            </div>
          )}
